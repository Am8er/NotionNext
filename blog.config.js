...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AmberChu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Digital Marketing, Entrepreneur, AI, Cook', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://amberchu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog, Digital Marketing, Entrepreneur, AI, Foodie, Cook', // 网站关键词 英文逗号隔开
