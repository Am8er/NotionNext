...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/muon-website-favicon-black.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/muon-website-favicon-white.png', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg

  // MENU ， 菜单部分不在此处配置，请在Notion数据库中添加MENU

  // 英雄区块导航
  STARTER_HERO_ENABLE: true, // 开启英雄区
  STARTER_HERO_TITLE_1: 'Muon is Here to Supercharge Your Online Presence!', // 英雄区文字
  ...
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/hero-image1.webp', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_FOOTER_PRIVACY_POLICY_TEXT: '© 2024 Muon Digital Marketing Agency',
